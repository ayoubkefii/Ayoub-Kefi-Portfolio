        ...
        <div className="container-custom relative z-10">
          ...
          <div className="space-y-8">
            ...
            <ScrollReveal direction="left" delay={0.1}>
              <motion.div className="glass-card flex flex-col md:flex-row md:items-center md:justify-between">
                <div className="flex items-center mb-4 md:mb-0">
                  <span className="text-purple-400 text-3xl mr-4">
                    🚀
                  </span>
                  <div>
            ...
            <ScrollReveal direction="left" delay={0.2}>
              <motion.div className="glass-card flex flex-col md:flex-row md:items-center md:justify-between">
                <div className="flex items-center mb-4 md:mb-0">
                  <span className="text-green-400 text-3xl mr-4">
                    💡
                  </span>
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
            ...
            <ScrollReveal direction="right" delay={0.3}>
              <motion.div className="glass-card flex flex-col md:flex-row md:items-center md:justify-between">
                <div className="flex items-center mb-4 md:mb-0">
                  <span className="text-yellow-400 text-3xl mr-4">
                    🔧
                  </span>
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
            ...
            {/* Web Developer (Freelance & Academic) */}
